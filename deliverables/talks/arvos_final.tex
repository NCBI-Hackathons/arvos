...
\frame{
\footnotesize
\begin{block}{Flask Part}
\begin{itemize}
\item[\checkmark] Use bootstrap theme
\item[\checkmark] Heatmap viewer
\item Table of contents view
\item Generic results view
\end{itemize}
\end{block}

\begin{block}{Pipleline Part}
\begin{itemize}
\item[\checkmark] Wrap DESeq2 in Associative Class
\item[\checkmark]Create counts to features utilities
\item Harmonize results formats
\end{itemize}
\end{block}

\begin{block}{Docker, Docs}
\begin{itemize}
\item[\checkmark] Dockerize postgreSQL database and API
\item Asthma meta-analysis example
\item Butterfly de-novo example
\end{itemize}
\end{block}
}
...
\scriptsize
 \begin{center}
    \includegraphics[scale=0.08]{web_app_page3.png}  
 \end{center} 
}
...
\scriptsize
 \begin{center}
    \includegraphics[scale=0.08]{web_app_page2.png}  
 \end{center} 
}
...
\scriptsize
 \begin{center}
    \includegraphics[scale=0.08]{web_app_page1.png}  
 \end{center} 
}
